Функция ЗагрузитьСообщенияИзTelegram() Экспорт
				...
				Для Каждого Сообщение Из СтруктураJson.result Цикл
					...
					Если Сообщение.Свойство("message") Тогда
						...
						Если Сообщение.message.Свойство("chat") Тогда
							...
							SendMessage("6891588067", "Бот получил ваше сообщение");
...
КонецФункции // ЗагрузитьСообщения()
...
Функция ПолучениеДокумента() Экспорт
	...
	Пока Выборка.Следующий() Цикл
		Текст = Текст + СтрШаблон("Дата создания документа %1", Выборка.Дата);
	КонецЦикла;
